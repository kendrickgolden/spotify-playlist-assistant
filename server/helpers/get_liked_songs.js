...
let artist_map_server;
let artist_map_client;

async function get_liked_songs() {
  const token = callbackRouter.token;
  artist_map_server = new Map();
  artist_map_client = new Map();
...
//Creates list of artists with all of their saved songs in the form:  {artist: ["track1_uri,track2_uri,..."]}
